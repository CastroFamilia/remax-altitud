...
atddChecklistPath: _bmad-output/test-artifacts/atdd-checklist-7-4-smart-agent-routing-from-shortlist.md
generatedTestFiles:
...
## ATDD Artifacts
- Checklist: `_bmad-output/test-artifacts/atdd-checklist-7-4-smart-agent-routing-from-shortlist.md`
