-- Uvita & Bahía Ballena premium content and metadata update
UPDATE "areas"
SET
  "description_en" = $$Elite Coastal Discovery: Discover Uvita & Bahía Ballena, Costa Rica
...
Living in Uvita means immersing yourself in a highly active and integrated coastal lifestyle. Here, you do not have to sacrifice urban logistics for tropical beauty. The town center features two major supermarkets, national bank branches, gourmet organic grocers, medical clinics, and a vibrant international dining scene that rivals the country's best culinary hubs.
...
[CTA_BUTTON]$$,
  ...
  "description_es" = $$Descubra Uvita y Bahía Ballena: El Motor Costero y Santuario Natural
...
La geografía aquí es altamente dinámica. Elevándose inmediatamente desde la costa plana y virgen hacia las espectaculares colinas cubiertas de selva de la Fila Costeña, Uvita ofrece una rica variedad de microclimas y opciones residenciales. Ya sea que desee vivir a pocos pasos de la suave arena dentro de la zona marítima o prefiera ascender 200 metros por las colinas para disfrutar de constantes brisas marinas y vistas espectaculares del atardecer sobre la Cola de Ballena, Uvita ofrece la experiencia costera definitiva.
...
Uvita disfruta de un clima tropical de playa con una temperatura promedio de 24°C a 32°C (75°F to 90°F). Mientras que las tierras bajas reciben el sol costero y brisas marinas agradables, ascender solo 100 a 200 metros por la colina crea un descenso térmico sumamente refrescante. El aire fresco de la montaña que fluye por las colinas por la noche reduce la necesidad de aire acondicionado, brindando un perfecto equilibrio climático natural.
...
[CTA_BUTTON]$$,
  ...
  "metadata" = $${"h1En": "The Coastal Hub of the South Pacific: Discover Uvita & Bahía Ballena, Costa Rica", "h1Es": "El Centro Costero del Pacífico Sur: Descubra Uvita y Bahía Ballena, Costa Rica", "seoTitleEn": "Real Estate & Homes for Sale in Uvita & Bahía Ballena | RE/MAX Altitud", "seoTitleEs": "Bienes Raíces y Casas en Venta en Uvita y Bahía Ballena | RE/MAX Altitud", "seoDescriptionEn": "Explore real estate in Uvita and Bahía Ballena. Discover beach-side villas, oceanview estates on the Hermosa ridges, and luxury homes near the Marino Ballena Whale Tail.", "seoDescriptionEs": "Explore bienes raíces en Uvita y Bahía Ballena. Descubra villas cerca de la playa, quintas con vista al mar y casas de lujo cerca de la Cola de Ballena.", "elevation": "0 m – 200 m (0 ft – 650 ft)", "climate": "24°C – 32°C (75°F – 90°F)", "altitudeEn": "0 m – 200 m (0 ft – 650 ft)", "altitudeEs": "0 m – 200 m (0 ft – 650 ft)", "tempEn": "24°C – 32°C (75°F – 90°F)", "tempEs": "24°C – 32°C (75°F – 90°F)", "nearestAirport": "Quepos Airport (XQP) — 45 min / San José (SJO) — 3.5 hours", "nearestHospital": "Hospital de Osa (Cortés) — 15 min / Uvita Medical Centers — 2 min", "nearestBeach": "Playa Uvita (Marino Ballena) — 5 min", "investmentContext": {"appreciationTrend": "Solid 8-12% annual appreciation over 5 years driven by booming tourism and expat families", "rentalYieldEstimate": "7-11% high-yield vacation rentals and long-term expat housing", "marketHighlights": ["Marino Ballena National Park & world-famous Whale Tail sandbar", "Exceptional commercial and service infrastructure (banks, gourmet grocery, schools)", "High demand for luxury vacation rentals with stable occupancy"]}, "galleryImages": [{"url": "/images/areas/uvita-gallery-1.jpg", "captionEn": "The famous natural sandbar Whale Tail formation in Marino Ballena National Park.", "captionEs": "La famosa formación natural de Cola de Ballena en el Parque Nacional Marino Ballena."}, {"url": "/images/areas/uvita-gallery-2.jpg", "captionEn": "Uvita Waterfall (Catarata Uvita) tucked away in the lush jungle canopy.", "captionEs": "Catarata Uvita escondida en el exuberante dosel de la selva."}]}$$::jsonb
WHERE "slug" = 'uvita';
