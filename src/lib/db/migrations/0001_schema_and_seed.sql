...
INSERT INTO "offices" ("api_guid", "name", "area", "phone", "email", "address", "latitude", "longitude") VALUES
  ('FEA8746D-CC1D-41B8-89F3-D04AC98274AF', 'REMAX Altitud', 'Pérez Zeledón', '+506 6078 8887', 'hola@remax-altitud.cr', 'Detras de la escuela 12 de Marzo, Perez Zeledon', 9.3725, -83.7011),
  ('4AD5AE8F-5B47-4A1A-A953-40445F2B4940', 'REMAX Altitud Cero', 'Dominical/Uvita', '+506 6103 2936', 'cero@remax-altitud.cr', 'Calle principal frente a la cancha de Futbol de Playa Dominical', 9.257, -83.885)
