...
export async function FeaturedAreas({ locale }: FeaturedAreasProps) {
  ...
  const areasList = staticAreas.map((staticArea) => {
    ...
    const name = locale === "es"
      ? (dbArea?.nameEs || staticArea.nameEs)
      : (dbArea?.nameEn || staticArea.nameEn);
    ...
    >
      ...
      <div className="mb-6 flex items-end justify-between gap-4 md:mb-8">
        <div className="max-w-2xl">
          <h2 id="featured-areas-heading" className="text-3xl font-bold tracking-tight text-brand-navy md:text-4xl">
            {t("heading")}
          </h2>
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(to top, rgba(11, 30, 67, 0.95) 0%, rgba(11, 30, 67, 0.6) 45%, rgba(11, 30, 67, 0.1) 80%, transparent 100%)"
                }}
              />
                ...
                <div className="mt-2.5 flex flex-wrap gap-2 text-[10px] font-semibold text-white/80">
                  ...
                  {area.altitude && (
                    <div className="inline-flex items-center gap-1 rounded bg-white/10 px-2 py-0.5 backdrop-blur-md border border-white/5">
                      ...
                      >
                        <path fillRule="evenodd" d="M9.661 2.232a.75.75 0 0 1 .678 0l8 4.5A.75.75 0 0 1 18 7.38v5.24a.75.75 0 0 1-.339.626l-8 4.5a.75.75 0 0 1-.678 0l-8-4.5A.75.75 0 0 1 1 12.62V7.38a.75.75 0 0 1 .339-.626l8-4.5ZM9 4.195V10.25a.75.75 0 0 0 .375.65l5.125 2.883v-4.54L9 4.196Zm-1 0L2.875 9.243v4.54L8 10.9v-6.705Z" clipRule="evenodd" />
                      </svg>
